  ...
  return (
    <section className='banner'>
      ...
      <div className='game-explanation'>
        <p>
          <strong>{'Jojo\'s Bizarre Adventure'}</strong> is an <em>extravagant</em> and <em>thrilling</em> anime series that has a solid fanbase all around the globe.
          {'It\'s very common to identify with its multiple heroes. Actually, this brings out a crucial question:'}
        </p>
        <p>
          <em>
